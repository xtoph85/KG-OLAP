...
public class DemoAnalysis4DAbstractionIndividualGenerating extends DemoAnalysis {
  ...
  public void run() {
    ...
    this.getCube().groupByProperties(granularity, new String[] { "obj:operationalStatus" }, "obj:grouping");
  }
