...
public abstract class DemoDataset4D extends DemoDataset {
  private static final Logger logger = LoggerFactory.getLogger(DemoDataset4D.class);
  
  public DemoDataset4D() {
