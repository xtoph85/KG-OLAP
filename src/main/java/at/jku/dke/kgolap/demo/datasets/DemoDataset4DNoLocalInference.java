...
public abstract class DemoDataset4DNoLocalInference extends DemoDatasetNoLocalInference {
  private static final Logger logger = LoggerFactory.getLogger(DemoDataset4DNoLocalInference.class);
  
  public DemoDataset4DNoLocalInference() {
