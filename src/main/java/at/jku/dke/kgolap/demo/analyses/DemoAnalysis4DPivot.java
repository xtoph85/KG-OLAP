...
public class DemoAnalysis4DPivot extends DemoAnalysis {
  ...
  public void run() {
    ...
    this.getCube().pivot(granularity, "cube:hasLocation", "rdf:type", "obj:ManoeuvringAreaAvailability", "obj:hasLocation");
  }
