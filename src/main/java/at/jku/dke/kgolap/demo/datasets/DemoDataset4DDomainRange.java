...
public abstract class DemoDataset4DDomainRange extends DemoDatasetDomainRange {
  private static final Logger logger = LoggerFactory.getLogger(DemoDataset4DDomainRange.class);
  
  public DemoDataset4DDomainRange() {
