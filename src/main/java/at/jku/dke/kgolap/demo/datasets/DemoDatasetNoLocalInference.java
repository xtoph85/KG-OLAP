...
public abstract class DemoDatasetNoLocalInference extends DemoDataset {
  private static final Logger logger = LoggerFactory.getLogger(DemoDatasetNoLocalInference.class);
  ...
  public KGOLAPCube getKGOLAPCube(KGOLAPCubeProperties properties) {
    ...
    switch(this.getDimensionalSize()) {
      case TINY: 
        rulesetFileName = "rulesets/atm-1D-ruleset-no_local.ttl";
        break;
      case SMALL: 
        rulesetFileName = "rulesets/atm-2D-ruleset-no_local.ttl";
        break;
      default:
      case MEDIUM:
        rulesetFileName = "rulesets/atm-3D-ruleset-no_local.ttl";
        break;
      case LARGE: 
        rulesetFileName = "rulesets/atm-4D-ruleset-no_local.ttl";
        break;
    }
