...
public abstract class DemoDataset3DNoLocalInference extends DemoDatasetNoLocalInference {
  private static final Logger logger = LoggerFactory.getLogger(DemoDataset3DNoLocalInference.class);
  
  public DemoDataset3DNoLocalInference() {
