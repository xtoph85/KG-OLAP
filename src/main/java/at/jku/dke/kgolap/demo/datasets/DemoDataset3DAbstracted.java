...
public abstract class DemoDataset3DAbstracted extends DemoDataset {
  private static final Logger logger = LoggerFactory.getLogger(DemoDataset3DAbstracted.class);
  
  public DemoDataset3DAbstracted() {
