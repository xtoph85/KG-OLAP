...
public class MergeUnion3DDemoDatasetTest extends OperatorTest {
  private static final Logger logger = LoggerFactory.getLogger(MergeUnion3DDemoDatasetTest.class);
  
  public MergeUnion3DDemoDatasetTest() {
    super();
  }
  ...
  public void testTypeRegionMonthMerge() {  
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "        FILTER(!(?airLevel = cube:Level_Aircraft_Type && ?locLevel = cube:Level_Location_Region && ?datLevel = cube:Level_Date_Month))\r\n" + 
          "    }\r\n" + 
          "    GRAPH ?m {\r\n" + 
          "        ?s ?p ?o .\r\n" + 
          "    }\r\n" + 
