...
public class Reification3DDemoDatasetTest extends OperatorTest {
  private static final Logger logger = LoggerFactory.getLogger(Reification3DDemoDatasetTest.class);
  
  public Reification3DDemoDatasetTest() {
    super();
  }
