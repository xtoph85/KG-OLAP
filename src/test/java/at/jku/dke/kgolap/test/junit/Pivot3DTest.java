...
public class Pivot3DTest extends OperatorTest {
  private static final Logger logger = LoggerFactory.getLogger(Pivot3DTest.class);
  ...
  public void loadTestdata() {
    ...
    Map<String, String> allSlice = new HashMap<String, String>();
  ...
  public void testPivotWithGranularityLevel() {
    Map<String,String> regionLevel = new HashMap<String,String>();
    ...
    this.getKGOLAPCube().pivot(regionLevel, "cube:hasLocation", "rdf:type", "obj:GroupedType", "obj:hasLocation");
  }
}
