...
public class SliceDice3DTest extends OperatorTest {
  private static final Logger logger = LoggerFactory.getLogger(SliceDice3DTest.class);

  public SliceDice3DTest() {
    super();
  }
  ...
  public void testAircraftFixedWingRegionLOVVSelection() {
    ...
    // cube:Ctx-0, cube:Ctx-1, cube:Ctx-2, cube:Ctx-3, cube:Ctx-4, cube:Ctx-5, cube:Ctx-6
    {
      ...
      map.put("cube:hasAircraft", "cube:Level_Aircraft_Model-A380");
      map.put("cube:hasLocation", "cube:Level_Location_Segment-LOWW");
      map.put("cube:hasDate", "cube:Level_Date_Day-13February2020");
      coordinateMaps.add(map);
    ...
    assertTrue(repositoryContainsQuad(tempRepo, "<ckr:global-inf>", "cube:Ctx-2", "olap:covers", "cube:Ctx-4"));
    assertTrue(repositoryContainsQuad(tempRepo, "<ckr:global-inf>", "cube:Ctx-2", "olap:covers", "cube:Ctx-5"));
    assertTrue(repositoryContainsQuad(tempRepo, "<ckr:global-inf>", "cube:Ctx-2", "olap:covers", "cube:Ctx-6"));
