...
public class SliceDice4DDemoDatasetTest extends OperatorTest {
  private static final Logger logger = LoggerFactory.getLogger(SliceDice4DDemoDatasetTest.class);

  public SliceDice4DDemoDatasetTest() {
    super();
  }
  ...
  public void testFullSelection() {
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          "ASK {\r\n" + 
          "    {\r\n" + 
          "        SELECT ?air ?loc ?dat ?imp (COUNT(?ctx) AS ?cnt) WHERE {\r\n" + 
          "            GRAPH ckr:global {\r\n" + 
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "                    ?ctx cube:hasImportance/olap:atLevel cube:Level_Importance_All .\r\n" +
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          "ASK {\r\n" + 
          "    {\r\n" + 
          "        SELECT ?vor ?air1 ?air2 ?loc1 ?loc2 ?date1 ?date2 ?imp1 ?imp2 WHERE {\r\n" + 
          "            GRAPH ckr:global {\r\n" + 
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "                    {\r\n" + 
          "                        SELECT DISTINCT ?taxiway ?availability ?air1 ?air2 ?loc1 ?loc2 ?date1 ?date2 ?imp1 ?imp2 WHERE {\r\n" + 
          "                            GRAPH ckr:global {\r\n" + 
          "                                ?ctx1 ckr:hasAssertedModule ?m1 .\r\n" + 
          "                                ?ctx2 ckr:hasAssertedModule ?m2 .\r\n" + 
          "                                ?ctx1 cube:hasAircraft ?air1 .\r\n" + 
          ...
          "                    {\r\n" + 
          "                        SELECT DISTINCT ?runway ?availability ?air1 ?air2 ?loc1 ?loc2 ?date1 ?date2 ?imp1 ?imp2 WHERE {\r\n" + 
          "                            GRAPH ckr:global {\r\n" + 
          "                                ?ctx1 ckr:hasAssertedModule ?m1 .\r\n" + 
          "                                ?ctx2 ckr:hasAssertedModule ?m2 .\r\n" + 
          "                                ?ctx1 cube:hasAircraft ?air1 .\r\n" + 
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "                        ?imp olap:directlyRollsUpTo* ?imp1 .\r\n" + 
          "                    }\r\n" + 
          "                    GRAPH ?m {\r\n" + 
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "            ?coveredCtx cube:hasImportance/olap:atLevel cube:Level_Importance_Package .\r\n" + 
          "        }\r\n" + 
          "        GRAPH <ckr:global-inf> {\r\n" + 
    ...
    
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes() +
          ...
          "            ?coveredCtx cube:hasImportance/olap:atLevel cube:Level_Importance_Importance .\r\n" + 
          "        }\r\n" + 
          "        GRAPH <ckr:global-inf> {\r\n" + 
          "            ?ctx olap:covers ?coveredCtx .\r\n" + 
          "        }\r\n" + 
  ...
  public void testRegionSelection() {
    ...
    {
      String sparql = this.getKGOLAPCube().getSparqlPrefixes()
          + "SELECT ?aircraft ?location ?date ?imp WHERE {\n"
          + "  GRAPH ckr:global{\n"
      ...
      regionSlice.put("cube:hasImportance", "<" + diceCoordinates[3].trim() + ">");
